    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["task_id"], name="django_task_task_id_8fe621_idx"
                    ),
                    models.Index(
                        fields=["worker_id"], name="django_task_worker__252d90_idx"
                    ),
                    models.Index(
                        fields=["queue_name"], name="django_task_queue_n_69ba4d_idx"
                    ),
                    models.Index(
                        fields=["backend_name"], name="django_task_backend_c617ca_idx"
                    ),
                ],
                "unique_together": {
